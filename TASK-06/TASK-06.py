...
# Accessing methods to demonstrate functionality
print(my_new_car.get_descriptive_name())
...
class Battery():
    """A class to represent the battery of an electric car."""
...
class ElectricCar(Car):
    ...
    def __init__(self, make, model, year):
        ...
        Then initialize attributes specific to an electric car."""
        super().__init__(make, model, year)
        self.battery = Battery()  # Create an instance of Battery for each ElectricCar
